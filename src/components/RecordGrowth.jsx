  ...
  const monthlyStatData = [
    {
      tag: (
        <span>
          <span className="blue">2</span>/30일
        </span>
      ),
      text: "참여일",
    },
    ...
    <RecordGrowthWrapper showState={showState}>
      ...
      <div className="statistics">
        <h2>
          라이언님,
          <br />
          이번 달은 20일 챌린지를 완료했어요
        </h2>
        <p>
          지난 달보다 <span className="blue">1일 더 달성</span>했어요!
        </p>
      ...
      <div className="weeklyStatistics">
        {subscriber ? (
          <>
            ...
            <p>
              지난 주보다 <span className="blue">1일 더 달성</span>했어요!
            </p>
            <div className="visualized">
              <RecordGrowthTable />
            </div>
